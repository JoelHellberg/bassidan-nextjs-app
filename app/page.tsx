...
export default function Home() {
  return (
    <div className="flex-1">
      <div className="relative flex items-center w-full h-[90vh] mobile:grid mobile:h-auto mobile:w-full p-8 handheld:p-0 pb-12">
      ...
      <div className="flex w-full bg-blue-500 mobile:bg-slate-100 pt-10 mobile:pt-0">
